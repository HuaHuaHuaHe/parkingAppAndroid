...
public class GuideActivity extends BaseActivity {
    ...
    private void showOverlay() {
        ...
        BNItemizedOverlay overlay = new BNItemizedOverlay(
                GuideActivity.this.getResources().getDrawable(R.drawable.navi_guide_turn));
    ...
    //进去室内导航
    private void startIndoor(){
        Intent intent_indoor = new Intent(getApplicationContext(),GuideIndoorActivity.class);
